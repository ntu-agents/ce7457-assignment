...
from submission.constants import Q3_DQN_CARTPOLE_CONSTANTS as CARTPOLE_CONSTANTS
from submission.constants import Q3_DQN_MOUNTAINCAR_CONSTANTS as MOUNTAINCAR_CONSTANTS
from submission.question3.agents import DQN
from submission.question3.replay import ReplayBuffer
...
ENV = "MOUNTAINCAR" # set to "CARTPOLE" to run DQN on CartPole (useful as a sanity check; not assessed for DQN)
...
SWEEP_RESULTS_FILE_CARTPOLE = "DQN-CartPole-sweep-results.pkl"
