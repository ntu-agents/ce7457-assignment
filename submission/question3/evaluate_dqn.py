...
from submission.question3.train_dqn import play_episode, CARTPOLE_CONFIG, SWEEP_RESULTS_FILE_CARTPOLE, MOUNTAINCAR_CONFIG, SWEEP_RESULTS_FILE_MOUNTAINCAR
...
def evaluate(env: gym.Env, config, output: bool = True) -> float:
    """
    Restore a trained DQN agent from ``config['save_filename']`` and evaluate its greedy
