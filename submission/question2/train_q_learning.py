...
from submission.constants import Q2_QL_CONSTANTS as CONSTANTS
from submission.question2.agents import QLearningAgent
from submission.question2.utils import evaluate
...
def train(env, config):
    ...
    for eps_num in tqdm(range(1, config["total_eps"]+1)):
        ...
        while t < config["eps_max_steps"]:
            ...
            agent.learn(obs, act, reward, n_obs, terminated)
