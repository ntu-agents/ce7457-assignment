...
class Agent(ABC):
    ...
    **ONLY CHANGE THE BODY OF THE act() FUNCTION**
    ...
    def schedule_hyperparameters(self, timestep: int, max_timestep: int):
        ...
        This function is called before every environment step and allows you to schedule
        your hyperparameters.

        :param timestep (int): number of environment steps elapsed so far in training
