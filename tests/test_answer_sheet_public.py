...
def collect_questions():
    import submission.answer_sheet as answer_sheet
    questions = []
...
def question_specs():
    ...
    specs = {
        ...
        "question4_1": ("multi_choice", ("a", "b", "c")),
        "question4_2": ("multi_choice", ("a", "b", "c")),
        "question4_3": ("multi_choice", ("a", "b", "c")),
...
def test_questions_outputs(collect_questions, question_specs):
    ...
    def test_short_answer(question, question_type_args):
        return len(question().split()) <= question_type_args[0], f"Answer '{question()}' from {question.__name__} exceeds max words"
